  ...
  <el-dialog :title="!dataForm.attrGroupId ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible" @closed="dialogClose">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="所属分类" prop="catelogId">
        <el-cascader v-model="dataForm.catelogPath" placeholder="试试搜索什么..." :options="categories" :props="props" filterable></el-cascader>
        <!-- <el-cascader v-model="dataForm.catelogId" :options="categories" :props="{ expandTrigger: 'hover' }"></el-cascader> -->
      </el-form-item>
    </el-form>
